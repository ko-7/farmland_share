                ...
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <div class="flex justify-between">
                            ...
                            <!-- <button class="items-center block px-10 py-2.5 text-base font-medium text-center text-blue-600 transition duration-500 ease-in-out transform hover:text-blue-400 focus:bg-gray-400" onclick="location.href='/users/add'">
                                新規作成
                            </button> -->
                        </div>
